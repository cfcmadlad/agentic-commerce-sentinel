 ...
 *
 * Reads from the mock fixture module, not a live call against the real
 * FastAPI service (which now exists under /service). Every value rendered
 * here comes from the real BaselineDecision/EnsembleDecision/AttributionRow/
