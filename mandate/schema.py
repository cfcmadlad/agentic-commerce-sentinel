...
follows that direction anyway. See the interop ADR
(`docs/adr/0010-ap2-interop-adapter.md`) for the full sourcing; this is a
defensible design point, not a claim of conformance to either spec.
