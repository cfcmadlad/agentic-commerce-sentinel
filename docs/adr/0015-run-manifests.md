...
The headline run itself (`--n-legitimate 20000 --seed 42`, matching the README's Results section's own documented reproduction command) was run for real to produce the authoritative manifest this project's actual reported numbers cite -- see the README's own citation of its hash.
