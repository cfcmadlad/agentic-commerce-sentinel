...
README claimed that the README itself needed a correction (see README §8
and `docs/adr/0010-ap2-interop-adapter.md`'s "what was assumed vs. what was
found" section). This package's adapter is honest about the result: it
